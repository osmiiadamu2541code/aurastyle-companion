          ...
          {layers.length === 0 ? (
            ...
            layers.map((l) => {
              ...
              return (
                <div
                  key={l.slot}
                  className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-2xl border border-border bg-card px-3 py-2"
                >
                  <button type="button" onClick={() => advance(l)} className="min-w-0 text-left">
